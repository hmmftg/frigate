...
$enSet = [System.Collections.Generic.HashSet[string]]::new($enKeys)
$faSet = [System.Collections.Generic.HashSet[string]]::new($faKeys)

$missingInFa = $enKeys | Where-Object { -not $faSet.Contains($_) }
$extraInFa = $faKeys | Where-Object { -not $enSet.Contains($_) }
